...
async function importCommits(repoPath, repoName) {
  try {
    ...
    const stdout = execSync('git log --pretty=format:"%H|%ad|%s" --date=iso', { cwd: repoPath, encoding: 'utf8' });
...
async function run() {
  await importCommits('/Users/biw/Documents/jurnal', 'Jurnal');
  await importCommits('/Users/biw/Documents/BIW main', 'BIW Main');
  await importCommits('/Users/biw/Documents/shifat /task-tracker', 'Shifat Tracker');
  console.log("Done.");
}
